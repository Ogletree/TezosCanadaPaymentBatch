...
namespace TezosService.Model.TzScan
{
    public class Blocks
    {
        public static Blocks[] FromJson(string json) => JsonConvert.DeserializeObject<Blocks[]>(json, Converter.Converter.Settings);
        public static string ToJson(Blocks[] self) => JsonConvert.SerializeObject(self, Converter.Converter.Settings);[JsonProperty("hash")]
