...
namespace Tz.Net
{
    public class Wallet
    {
        ...
        public async Task<OperationResult> Transfer(string from, List<MyTrans> transactions, BigFloat fee, BigFloat gasLimit = null, BigFloat storageLimit = null)
        {
            return await new Rpc(Provider).SendTransaction(Keys, from, transactions, fee, gasLimit, storageLimit);
        }
    }
    ...
    public class MyTrans
    {
        ...
        public BigFloat Reward { get; set; }
        ...
        {
            return $"{Cycle}  {Name}  {Account}  {Percentage:P5}  {Reward}ꜩ  {TransactionHash}";
        }
    }
}